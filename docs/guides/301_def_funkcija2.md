...
- Riječ `def` označava definiciju funkcije te se nakon nje piše naziv funkcije koji podliježe pravilima imenovanju varijabli.
- Nakon naziva funkcije se u oblim zagradama nabrajaju parametri funkcije.
- Parametri funkcije su jednostavno varijable putem kojih korisnik funkciji šalje vrijednosti potrebne za izračun.
- Funkcija iz primjera prima jedan parametar koji je nazvan `numbers`.
- Nazivi parametara su zapravo nazivi varijabli koje možemo koristiti unutar tijela funkcije.
- Tijelo funkcije se podvlači pod samu liniju koja označava početak definicije funkcije kao što je slučaj i kod kondicionala i petlji.
